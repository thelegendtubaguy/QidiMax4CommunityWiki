...
* [Qidi Box filament saver V3 PTFE guide](https://makerworld.com/en/models/1899113-filament-saver-for-qidi-box-v3-ptfe-guide?from=search#profileId-2100788)
* [Qidi Box hub and external spool holder adapter](./mods/qidi_box_spool_adapter.md)
* [Vented Riser](https://www.printables.com/model/1604271-qidi-max-4-vented-riser-by-sac3d)

## Software

* [Klipper and Slicer GCode optimizations](https://github.com/thelegendtubaguy/Qidi-Max-4-Optimized)
* [Making qidiclient suck less](./mods/making_qidiclient_suck_less.md) (reduces CPU usage)
