...
This message means the filament is potentially wrapped/tangled or the printer tried to pull filament back from the toolhead and could not move it as expected.
