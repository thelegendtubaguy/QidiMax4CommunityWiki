...
[This cable chain](https://www.printables.com/model/1689178-qidi-max-4-polar-cooler-flexible-schlauchfuhrung) works a treat by bending the tube around the toolhead pivot point.  You can use [these clips by the same user](https://www.printables.com/model/1645027-qidi-max-4-polar-cooler-schlauchfuhrung-oben-und-s) to guide it along the rest of the toolhead cable chain!

![Polar cooler tubing route overview](../assets/polar_cooler_tubing_route_overview.jpg)

![Polar cooler tubing at the right side cable chain](../assets/polar_cooler_tubing_right_side.jpg)

![Polar cooler tubing entering the toolhead](../assets/polar_cooler_tubing_toolhead.jpg)
