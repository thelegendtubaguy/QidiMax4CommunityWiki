...
The polar cooler tubing measures roughly 4.5 mm inner diameter and 7.5 mm outer diameter. Treat those numbers as approximate rather than exact because the tubing is very soft and squishy, so the measurements can vary depending on how it is handled.
